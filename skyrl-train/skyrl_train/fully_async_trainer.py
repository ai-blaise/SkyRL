        ...
        for epoch in range(start_epoch, self.cfg.trainer.epochs):
            ...
            for _ in range(self.global_step, (1 + epoch) * self.num_steps_per_epoch + 1):
                with Timer("step", self.all_timings):
                    ...
                    # 4. After training: sync weights to inference engines.
                    # Use "in_place" pause mode to minimize disruption (preserves KV cache).
                    with Timer("sync_weights", self.all_timings):
                        await self.inference_engine_client.pause_generation(mode="in_place")
                        await self.async_sync_policy_weights_to_inference_engines()
                        await self.inference_engine_client.continue_generation()
